`2026.8.28 v1.0.0`
1. 首个 MusicFreeTV 版本，保留 MusicFree Android 版主要功能与插件协议
2. 新增 Android TV Leanback 启动入口、强制横屏与电视 Banner
3. 新增 10-foot 高级简约首页、全局遥控焦点状态与基础控件适配
4. 新增遥控器播放/暂停、上一首、下一首和菜单键控制
5. 更新包名、应用标识、独立更新通道、开源说明与隐私边界
