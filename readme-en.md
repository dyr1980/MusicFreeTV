...
Remote controls support visible directional focus, Select, Back, Play/Pause, Previous, Next, and Menu (queue). Build with Node.js 18+, JDK 17, Android SDK API 35, and your own Android signing key: `npm install`, then `npm run build-tv`.

This project is licensed under [AGPL-3.0](./LICENSE). Retain the upstream author, repository, license, and [`NOTICE`](./NOTICE) when modifying or distributing it. The upstream project also requests free, lawful, non-commercial distribution without “VIP/crack” marketing.
